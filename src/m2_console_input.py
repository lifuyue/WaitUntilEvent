...
def double_a_float():
    ...
    # ------------------------------------------------------------------
    x = float(input('A floating point number: '))
    print(x * 2)
...
def print_an_integer_many_times():
    ...
    #   The testing code is already written for you (above).
    # ------------------------------------------------------------------
    x = int(input('A positive integer: '))
    for i in range(x):
        print(x * 2)
...
def input_it_all():
    ...
    #   The testing code is already written for you (above).
    # ------------------------------------------------------------------
    x = float(input('A positive floating point number: '))
    n = int(input('A positive integer: '))
    string = str(input('What words do you want to print? '))
    for i in range(n):
        print(math.sqrt(x))
    for j in range(n):
        print(string)
